...
# Created 2026-01-29 15:22:53

CASEDIR="/users_home/cmcc/cp1/CPS/CMCC-CPS1/refcases/juno/CPS1_HIST_reference"

/users_home/cmcc/cp1/CMCC-CM//cime/scripts/create_newcase --case "${CASEDIR}" --compset HIST_CAM60%WCSC_CLM51%BGC-CROP_CICE_NEMO_HYDROS_SGLC_SWAV --res f05_n0253 --driver nuopc --mach juno --run-unsupported
