...
#SBATCH --err=/leonardo_work/CMCC_2026//CPS/CMCC-CPS1/logs/hindcast/monitor/check_dead_time_%J.err
#SBATCH --out=/leonardo_work/CMCC_2026//CPS/CMCC-CPS1/logs/hindcast/monitor/check_dead_time_%J.txt
