#!/bin/sh -l
#BSUB -J copy_SPS4Forecast_from_Leonardo_5
#BSUB -q s_download
#BSUB -o /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4Forecast_from_Leonardo_5.out.%J  
#BSUB -e /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4Forecast_from_Leonardo_5.err.%J  
#BSUB -P 0784
#BSUB -M 1000
...
job_run=`$DIR_UTIL/findjobs.sh -m $machine -n copy_SPS4Forecast_from_Leonardo_5 -c yes`
if [[ $job_run -gt 1 ]]
then
   exit 0
fi
...
yyyy=`date +%Y`
st=`date +%m`
#leo_dir=/leonardo_work//CMCC-CM/archive/
#leo_dir_CASES=/leonardo_work///CPS/CMCC-CPS1/cases
#leo_dir_temp=/leonardo_work//scratch/CMCC-CPS1/temporary
leo_dir=/leonardo_work/CMCC_2026/CMCC-CM/archive #/leonardo_work//CMCC-CM/archive/
leo_dir_CASES=/leonardo_work/CMCC_2026/CPS/CMCC-CPS1/cases #/leonardo_work///CPS/CMCC-CPS1/cases
leo_dir_temp=/leonardo_work/CMCC_2026/scratch/CMCC-CPS1/temporary
