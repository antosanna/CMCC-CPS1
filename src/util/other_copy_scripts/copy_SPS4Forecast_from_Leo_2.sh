#!/bin/sh -l
#BSUB -J copy_SPS4Forecast_from_Leo_2
#BSUB -q s_download
#BSUB -o /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4Forecast_from_Leo_2.out.%J  
#BSUB -e /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4Forecast_from_Leo_2.err.%J  
#BSUB -P 0490
#BSUB -M 1000
...
lista_today_1=" "
#for ens in 013 015 016 017 018
#for ens in 046 051 052 053
for ens in 026
do
