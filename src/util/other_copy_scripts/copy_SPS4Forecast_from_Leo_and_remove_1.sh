#!/bin/sh -l
#BSUB -J copy_SPS4Forecast_from_Leo_and_remove_1
#BSUB -q s_download
#BSUB -o /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4Forecast_from_Leo_and_remove_1.out.%J  
#BSUB -e /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4Forecast_from_Leo_and_remove_1.err.%J  
#BSUB -P 0490
#BSUB -M 1000
...
logfile=$DIR_TEMP/list1_cases_transferred_forecast_`date +%Y%m`.txt
