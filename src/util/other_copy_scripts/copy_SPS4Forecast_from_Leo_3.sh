#!/bin/sh -l
#BSUB -J copy_SPS4Forecast_from_Leo_3
#BSUB -q s_download
#BSUB -o /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4Forecast_from_Leo_3.out.%J  
#BSUB -e /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4Forecast_from_Leo_3.err.%J  
#BSUB -P 0490
#BSUB -M 1000
...
lista_today_1=" "
#for ens in 019 020 022 023 025 
#for ens in 049 050 054 
for ens in 037 
do
