#!/bin/sh -l
#BSUB -J copy_SPS4DMO_from_Leonardo_singlecase
#BSUB -q s_download
#BSUB -o /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4DMO_from_Leonardo_singlecase.out.%J  
#BSUB -e /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4DMO_from_Leonardo_singlecase.err.%J  
#BSUB -P 0490
#BSUB -M 1000
