#!/bin/sh -l
#BSUB -J copy_SPS4Forecast_from_Leo_8
#BSUB -q s_download
#BSUB -o /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4Forecast_from_Leo_8.out.%J  
#BSUB -e /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4Forecast_from_Leo_8.err.%J  
#BSUB -P 0490
#BSUB -M 1000
...
lista_today_1=" "
for ens in 052 049 038 034 023 020 051
do
