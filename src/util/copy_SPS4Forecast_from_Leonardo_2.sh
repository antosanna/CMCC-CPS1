#!/bin/sh -l
#BSUB -J copy_SPS4Forecast_from_Leonardo_2
#BSUB -q s_download
#BSUB -o /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4Forecast_from_Leonardo_2.out.%J  
#BSUB -e /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4Forecast_from_Leonardo_2.err.%J  
#BSUB -P 0784
#BSUB -M 1000
...
job_run=`$DIR_UTIL/findjobs.sh -m $machine -n copy_SPS4Forecast_from_Leonardo_2 -c yes`
if [[ $job_run -gt 1 ]]
then
   exit 0
fi
