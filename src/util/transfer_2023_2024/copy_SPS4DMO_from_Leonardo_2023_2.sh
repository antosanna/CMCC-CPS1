...
idjob=`$DIR_UTIL/findjobs.sh -n copy_SPS4DMO_from_Leonardo2 -i yes`
logfile=$DIR_TEMP/list2_cases_transferred_`date +%Y%m%d`.$idjob.txt
echo $lista_today_2 > $logfile
