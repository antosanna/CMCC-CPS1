#!/bin/sh -l
#BSUB -J copy_SPS4DMO_from_Leonardo6
#BSUB -q s_download
#BSUB -o /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4DMO_from_Leonardo6.out.%J  
#BSUB -e /work/cmcc/cp1/CPS/CMCC-CPS1/logs/leonardo_transfer/copy_SPS4DMO_from_Leonardo6.err.%J  
#BSUB -P 0784
#BSUB -M 1000
...
idjob=`$DIR_UTIL/findjobs.sh -n copy_SPS4DMO_from_Leonardo6 -i yes`
logfile=$DIR_TEMP/list6_cases_transferred_`date +%Y%m%d`.$idjob.txt
echo $lista_today_6 > $logfile
