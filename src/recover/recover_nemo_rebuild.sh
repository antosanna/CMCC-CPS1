#!/usr/bin/sh -l
#BSUB  -J nemo_rebuild.sps4_199307_001 
#BSUB  -n 1 
#BSUB  -o ../../logs/recover/nemo_rebuild.sps4_199307_001.stdout.%J  
#BSUB  -e ../../logs/recover/nemo_rebuild.sps4_199307_001.stderr.%J  
#BSUB  -R "span[ptile=1]"
#BSUB  -P 0574
. ~/.bashrc
. $DIR_UTIL/descr_CPS.sh
set -euvx
CASEROOT=/work/csp/sps-dev/CPS/CMCC-CPS1/cases/sps4_199307_001
cd $CASEROOT
