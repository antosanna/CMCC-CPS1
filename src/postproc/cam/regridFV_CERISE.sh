...
then
   ...
   then
       ...
       if [[ ${solinfile_n} -ne 0 ]] ; then
             ...
             rsync -auv $solinfile_templ $SCRATCHDIR/regrid_CERISE/$caso/CAM/
             ...
             ncap2 -Oh -s 'realization(0:8)="r'$member'i00p00"' $SCRATCHDIR/regrid_CERISE/$caso/CAM/$solinfile_templ_name $SCRATCHDIR/regrid_CERISE/$caso/CAM/${solinfile_new_name}
             ncatted -Oh -a ic,global,o,c,"$ic" $SCRATCHDIR/regrid_CERISE/$caso/CAM/${solinfile_new_name}
             rsync -auv $SCRATCHDIR/regrid_CERISE/$caso/CAM/${solinfile_new_name} $outdirC3S
       else
