...
def plot_max_field(fullfield, field, title, logdir, plotname="plot_2.png"):
    """
    Plot panel of monthly maximum
    """
    ...
    plotfield = plotfield.groupby('time.month').max(dim='leadtime')
