...
def plot_min_field(fullfield, field, title, logdir, plotname="plot_3.png"):
    """
    Plot panel of monthly minimum
    """
    ...
    plotfield = plotfield.groupby('time.month').min(dim='leadtime')
