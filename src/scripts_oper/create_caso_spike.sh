...
cp $DIR_ROOT/development_tmp/ANTO/namelists_spike/user_nl_cam $DIR_CASES/$caso/user_nl_cam
...
cp $DIR_ROOT/development_tmp/ANTO/namelists_spike/user_nl_clm $DIR_CASES/$caso/user_nl_clm
