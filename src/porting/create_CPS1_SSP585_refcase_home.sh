...
$DIR_CESM/cime/scripts/create_newcase --case $DIR_REFCASES/$caso --compset SSP585_CAM60%WCSC_CLM51%BGC-CROP_CICE_NEMO_HYDROS_SGLC_SWAV --res f05_n0253 --driver nuopc --mach $machine --run-unsupported
