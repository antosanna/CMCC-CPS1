...
$DIR_CESM/cime/scripts/create_newcase --case $DIR_CASES/$caso --compset HIST_CAM60%WCSC_CLM51%BGC-CROP_CICE_NEMO_HYDROS_SGLC_SWAV --res f05_n0253 --driver nuopc --mach juno --run-unsupported
...
./xmlchange RUN_REFDIR=/work/$DIVISION/cp1/restart_cps_test/
