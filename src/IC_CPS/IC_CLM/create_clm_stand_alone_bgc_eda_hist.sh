...
sed 's/MEMBER/'$member'/g' ${DIR_TEMPL}/user_nl_datm_streams_eda_hist > $DIR_CASES/$caze/user_nl_datm_streams
#to deactivate reset_snow
sed 's/reset_snow/!reset_snow/g' ${DIR_TEMPL}/user_nl_clm_NoSnAg > $DIR_CASES/$caze/user_nl_clm
