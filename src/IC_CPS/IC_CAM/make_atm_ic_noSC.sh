...
${DIR_UTIL}/submitcommand.sh -m $machine -S $qos -t "1" -q $serialq_s -j ${caso}_launch -l ${DIR_LOG}/$typeofrun/$yyyy$st/IC_CAM -d ${DIR_ATM_IC} -s ${CPSSYS}_IC4CAM_noSC.sh -i "$input"
exit 0
