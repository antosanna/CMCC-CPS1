...
do
  ...
  then
       export lead=$(($l - 1))
       export SS=${S[$l]}
       #export probupfile="${CLIM_OBS_DIR_DIAG}/pctl/$DATASET/${varm}_${mmfore}_${iniy_hind}-${endy_hind}_l${lead}_66.nc"
       #export problowfile="${CLIM_OBS_DIR_DIAG}/pctl/$DATASET/${varm}_${mmfore}_${iniy_hind}-${endy_hind}_l${lead}_33.nc"
       ...
       #export probupfile="${CLIM_OBS_DIR_DIAG}/pctl/$DATASET/monthly/${varm}_${mmfore}_${iniy_hind}-${endy_hind}_l${lead}_66.nc"
       #export problowfile="${CLIM_OBS_DIR_DIAG}/pctl/$DATASET/monthly/${varm}_${mmfore}_${iniy_hind}-${endy_hind}_l${lead}_33.nc"
  ...
  export inputm="$anomdir/${varm}_${SPSSystem}_${yyyyfore}${mmfore}_ens_ano.${iniy_hind}-${endy_hind}.nc"
  export inputmall="$anomdir/${varm}_${SPSSystem}_${yyyyfore}${mmfore}_all_ano.${iniy_hind}-${endy_hind}.nc"
  export landmask="$MYCESMDATAROOT/CMCC-${CPSSYS}/files4${CPSSYS}/lsm_C3S.nc"
  export inputclim_mm="${DIR_CLIM}/monthly/${varm}/C3S/clim/${varm}_${SPSSystem}_clim_${iniy_hind}-${endy_hind}.${mmfore}.nc"
