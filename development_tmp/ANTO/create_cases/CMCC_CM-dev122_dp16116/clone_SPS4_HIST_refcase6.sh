...
./case.build
#SECTION FOR NEMO 
# after copy namelist and then this will be refcase
cp /work/$DIVISION/$USER/scratch/SPS4_HIST_hyb_refcase/Buildconf/nemoconf/file_def_nemo-oce.xml2 $CASEDIR/Buildconf/nemoconf/file_def_nemo-oce.xml
