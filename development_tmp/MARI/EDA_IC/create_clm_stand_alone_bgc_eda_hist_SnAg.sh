...
refcase="cm3_lndHIST_bgc_SnAg2_eda${member}_cyc1960"
caze="cm3_lndHIST_bgc_SnAg2_eda${member}_hist"
...
sed 's/reset_snow/!reset_snow/g' $script_dir/nml/user_nl_clm_SnAg > $DIR_CASES/$caze/user_nl_clm
